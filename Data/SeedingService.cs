...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; // Banco de dados já polulado
            }
            ...
            Seller s2 = new Seller(2, "Ronaldo Cristiano", "cristiano@gmail.com", new DateTime(1978, 4, 3), 1500.00, d2);
            Seller s3 = new Seller(3, "James Brown", "james@hotmail.com", new DateTime(2001, 6, 19), 5600.00, d1);
            Seller s4 = new Seller(4, "Britney Spears", "spears@yahoo.com", new DateTime(1988, 7, 25), 8900.00, d4);
            Seller s5 = new Seller(5, "Tupac Shakur", "tupac@gmail.com", new DateTime(1997, 9, 13), 1300.00, d3);
            Seller s6 = new Seller(6, "Pink Floyd", "pink@gmail.com", new DateTime(1999, 3, 20), 7000.00, d2);
